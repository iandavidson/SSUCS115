"""
    ...
    is in a box. tells which row and column
"""
...
def main():
    ...
    for i in range(10):
        ...
        if (100 < x_c_point < (100 + num_columns * width)):
            if (100 < y_c_point < (100 + num_rows * height)):
                print('The click at (' , x_c_point , ", ", y_c_point ,') is in row ' , place_row , ", column " , place_columns , ".", sep = "")
            else:
